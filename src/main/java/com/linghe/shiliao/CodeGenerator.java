...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        packageInfo.setParent("com.linghe.shiliao");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
...
//        TableFill tableFill3 = new TableFill("create_user", FieldFill.INSERT);
//        TableFill tableFill4 = new TableFill("update_user", FieldFill.INSERT_UPDATE);
